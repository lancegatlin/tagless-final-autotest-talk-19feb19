...
and ScalaCheck to automatically test "laws" (i.e. rules) against an example
final tagless algebra. Using a generic law-based testing approach, we will write
...
* How to write generic laws to test a final tagless algebra
